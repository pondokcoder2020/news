<script type="text/javascript">
    ...
    $(function(){
        ...
        let idReservasi = __PAGES__[3];

        if (idReservasi != "" && idReservasi != undefined) {
            ...
            $.ajax({
                ...
                success: function(response){
                    ...
                    if (response != "" && response != undefined) {
                        ...
                        $("#nik").val(metaData[0].noktp);
                        $("#email").val(metaData[0].email);
                        $("#nama").val(metaData[0].nama_pasien);
                        $("#tanggal_lahir").val(metaData[0].tanggal_lahir);
                        $("#alamat").val(metaData[0].alamat);
                        $("#no_telp").val(metaData[0].nohp);
                        //$("#agama").val(metaData.id_agama);
				...
				$.ajax({
					...
					success: function(response){
                        ...
                        if (response.response_package.response_unique != ""){	//check returning uid
                            ...
                            location.href = __HOSTNAME__ + `/rawat_jalan/antrian_online/tambah_antrian/${idReservasi}/${response.response_package.response_unique}`;
