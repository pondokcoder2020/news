<script type="text/javascript">
    $(function () {
        ...
        var dataKategori = $("#table-berita-kategori").DataTable({
            processing: true,
            serverSide: true,
                ...
                },
                {
                    "data" : null, render: function(data, type, row, meta) {
                        return "<div class=\"btn-group wrap_content\" role=\"group\" aria-label=\"Basic example\">" +
                            "<button id=\"edit_" + row.uid + "\" class=\"btn btn-info btn-sm btnEdit\">" +
        ...
        $("body").on("click", ".btnEdit", function () {
            ...
            $.ajax({
                async: false,
                url: __HOSTAPI__ + "/Berita/detail_kategori/" + uid,
                type: "GET",
                ...
                success: function (response) {
                    ...
                    $("#txt_nama").val(data.name)
                    $("#txt_keterangan").val(data.description);
        ...
        $("body").on("click", ".btnDelete", function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        async: false,
                        url: __HOSTAPI__ + "/Berita/kategori/" + uid,
                        type: "DELETE",
                        beforeSend: function (request) {
                            request.setRequestHeader("Authorization", "Bearer " + <?php echo json_encode($_SESSION["token"]); ?>);
                        },
