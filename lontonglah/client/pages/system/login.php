		...
		<div class="layout-login__form" data-simplebar>
			<div class="d-flex justify-content-center mt-2 mb-5 navbar-light">
				<a href="<?php echo __HOSTNAME__; ?>/" class="navbar-brand" style="min-width: 0">
					<img class="navbar-brand-icon" src="<?php echo __HOSTNAME__; ?>/template/assets/images/logo.png" width="180" height="180" alt="<?php echo __PC_CUSTOMER__; ?>">
			...
			<p class="mb-5 text-muted">Portal Management System</p>
