                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header card-header-large bg-white d-flex align-items-center">
                                <h5 class="card-header__title flex m-0">Kategori Berita</h5>
                                <button id="btnTambah" class="btn btn-purple">
                                    <i class="fa fa-plus"></i> Tambah
                                </button>
                            </div>
                            <div class="card-body tab-content">
                                <div class="tab-pane active show fade">
                                    <table class="table table-bordered" id="table-berita-kategori">
